      ...
      <li tabIndex={0}>
        <details style={{ backgroundColor: "white" }}>
          ...
          <ul className="p-2" style={{ backgroundColor: "white" }}>
            ...
            <li>
              <a style={{ color: "black" }}>Milk</a>
            </li>
            <li>
              <a style={{ color: "black" }}>Cheese</a>
            </li>
            <li>
              <a style={{ color: "black" }}>Butter</a>
            </li>
            <li>
              <a style={{ color: "black" }}>Yogurt</a>
            </li>
            <li>
              <a style={{ color: "black" }}>Paneer</a>
            </li>
            <li>
              <a style={{ color: "black" }}>Ice-Cream</a>
            </li>
            <li>
              <a style={{ color: "black" }}>Bread</a>
            </li>
            <li>
              <a style={{ color: "black" }}>Honey</a>
            </li>
          </ul>
        </details>
      </li>
